...
/**
 * Login multi-facility-user FXML Controller Class
 *
 * @author Manabu Nishimura <nishimurama@sandi.co.jp>
 */
public class MultiFaciUserLoginController extends AnchorPane implements Initializable {

    @FXML
    ChoiceBox<String> multiFacility;
    @FXML
    ChoiceBox<String> multiUser;
    @FXML
    PasswordField pwd;
    @FXML
    Text status;
    ...
    public void initialize(URL url, ResourceBundle rb) {
        ...
        multiUser.valueProperty().addListener(new javafx.beans.value.ChangeListener<String>() {
            @Override
            public void changed(ObservableValue ov, String t, String t1) {
                userId = t1;
            }
    ...
    public void execLogin(ActionEvent event) {
        ...
        ClientContext.getPart11Logger().info("Challenge Authentication is " + "\"" + userId + "\"");
        tryLogin();
    }
    ...
    public void lockOperation() {
        ...
        //- ログインID,Pass有効
        multiFacility.setDisable(true);
        multiUser.setDisable(true);
        pwd.setDisable(true);
        //- プログレス非表示
    ...
    public void unLockOperation() {
        ...
        //- ログインID,Pass有効
        multiFacility.setDisable(false);
        multiUser.setDisable(false);
