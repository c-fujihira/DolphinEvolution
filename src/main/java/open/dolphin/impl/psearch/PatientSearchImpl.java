...
//masuda$  
        ...
        // 患者検索リストをダブルクリック時、カルテオープン
        KeyStroke enter = KeyStroke.getKeyStroke(KeyEvent.VK_ENTER, 0);
        view.getTable().getInputMap(JTable.WHEN_ANCESTOR_OF_FOCUSED_COMPONENT).put(enter, "solve");
        view.getTable().getActionMap().put("solve", new EnterAction());
