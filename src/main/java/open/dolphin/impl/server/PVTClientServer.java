...
/**
 * PVT socket server PVTServer() listen to ORCA for MML file through socket
 * creates 'Connection' thread on getting MML file from ORCA
 *
 * @author Kazushi Minagawa, Digital Globe, Inc. Modified by Mirror-i corp for
