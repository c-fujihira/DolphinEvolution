...
//		return CString( "" );
    ...
    public String CHGKanatoASCII(String strKana, String strASCII) {
        ...
        String replace = sAsc.replace("$", "");
        String replace1 = sAsc.replace("OO", "OH");
        String replace2 = sAsc.replace("OU", "OH");
        String replace3 = sAsc.replace("AA", "A");
        String replace4 = sAsc.replace("II", "I");
        String replace5 = sAsc.replace("UU", "U");
        String replace6 = sAsc.replace("EE", "E");
