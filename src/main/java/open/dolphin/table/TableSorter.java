...
//masuda
        ...
        public void paintIcon(Component c, Graphics g, int x, int y) {
            ...
            ImageIcon upIcon = new ImageIcon(getClass().getResource("/resources/images/up.gif"));
            ImageIcon downIcon = new ImageIcon(getClass().getResource("/resources/images/down.gif"));
            if (descending) {
